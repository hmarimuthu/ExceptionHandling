...
public class TestDataContainer {
	 ...
	 */
	@HandleException(expected = { DataProviderException.class })
	public boolean addDataFile(String fileKey, String filePath) throws DataProviderException {
		...
		if (!dataFile.exists() && !dataFile.canRead()) {
			throw new DataProviderException(
					"Data File with Key=" + fileKey + " File Path = " + filePath + " does not exist");
		}
