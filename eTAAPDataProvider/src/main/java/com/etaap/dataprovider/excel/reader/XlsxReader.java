package com.etaap.dataprovider.excel.reader;
...
public class XlsxReader extends ExcelReader {
	 ...
	 * 
	 * @see com.etaap.core.datamanager.excel.ExcelReader#getCellData(java.lang
	 ...
	 * 
	 * @see com.etaap.core.datamanager.excel.ExcelReader#setCellData(java.lang
	...
	/**
	 * Removes the sheet. returns true if sheet is removed successfully else
	 ...
	 * 
	 * @see com.etaap.core.datamanager.excel.ExcelReader#addColumn(java.lang
	 ...
	 * 
	 * @see com.etaap.core.datamanager.excel.ExcelReader#removeColumn(java.lang
	 *      .String, int)
	 */
	@Override
	@HandleException(expected = { Exception.class })
	 ...
	 * message
	 * 
	 * @see com.etaap.core.datamanager.excel.ExcelReader#addHyperLink(java.lang
	...
	public boolean addHyperLink(String sheetName, String screenShotColName, String testCaseName, int index,
			String urlValue, String message) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.etaap.core.datamanager.excel.ExcelReader#getCellRowNum(java.
