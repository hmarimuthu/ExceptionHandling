 ...
 */
public abstract class ExcelReader implements ExceptionListener {
	 ...
	 * @return true, if successful
	 */
	protected abstract boolean addHyperLink(String sheetName, String screenShotColName, String testCaseName, int index,
	...
	public String getCellData(Workbook workbook, String sheetName, String colName, int rowNum) {
		try {
			...
			log.error(e);
			String exResult = "row " + rowNum + " or column " + colName + " does not exist in xls";
	...
	public String getCellData(Workbook workbook, String sheetName, int colNum, int rowNum) {
		try {
			...
			log.error(e);
			String exResult = "row " + rowNum + " or column " + colNum + " does not exist in xls";
			ExceptionHandler ex = new ExceptionHandler();
			ex.handleit(this, new Exception(exResult));
			return exResult;
		}
	 ...
	 */
	@HandleException(expected = { Exception.class })
	protected boolean setCellData(String path, Workbook workbook, String sheetName, String colName, int rowNum,
			String data) {
		Sheet sheet = null;
		boolean isSet = false;
		try {
