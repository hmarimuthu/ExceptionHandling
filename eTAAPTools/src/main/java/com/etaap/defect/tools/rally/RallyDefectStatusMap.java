...
public enum RallyDefectStatusMap {
	...
	SUBMITTED("Submitted", KDConstants.NEW_DEFECT.getValue()), OPEN("Open",
			KDConstants.UPDATE_DEFECT.getValue()), FIXED("Fixed",
					KDConstants.CLOSE_DEFECT.getValue()), CLOSED("Closed", KDConstants.CLOSE_DEFECT.getValue());
