...
public class RequestInfo {
	...
	public RequestInfo(String reqType, String key, Map<String, String> reqEntries) {
		...
		for (Map.Entry<String, String> mentry : reqEntries.entrySet()) {
			addEntry(key, mentry.getKey(), mentry.getValue());
		}
	}
	 ...
	 *
	 * @param attachmentPresent
	 *            the new attachment present
	 */
