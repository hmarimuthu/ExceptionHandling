...
import com.etaap.core.exception.EmailException;
...
public class EmailValidator implements IEmailValidator {
	 ...
	 *             the exception
	 */
	@HandleException(expected = { EmailException.class, Exception.class })
	public boolean validateMailMessages(Message[] messages, Properties props) throws Exception {
		...
		if (!isMailFound) {
			...
			throw new EmailException("Could not find any mail");
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.etaap.infra.mail.IEmailValidator#validateEmail(java.util.
	 * Properties )
	 */@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.etaap.infra.mail.IEmailValidator#
