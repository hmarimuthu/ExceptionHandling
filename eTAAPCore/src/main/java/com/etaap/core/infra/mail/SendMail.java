...
public class SendMail {
	...
	public static void main(String[] args) throws Exception {
		...
		SendMail.sendMail("etouchautomation@gmail.com", "etouch123", "smtp.gmail.com", "465", "true", "true", true,
				"javax.net.ssl.SSLSocketFactory", "false", to, cc, bcc, "Automation test Reports",
				"Please find the reports attached.\n\n Regards\nWebMaster",
				System.getProperty("user.dir") + "\\email_xlst_reports.zip", "email_xlst_reports.zip");
	...
	public static boolean sendMail(String userName, String passWord, String host, String port, String starttls,
...

		{
			...
			ex.handleit(SendMail.class, mex);
